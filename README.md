# <p align="center">🌐 CHETAN Forum</p>

<p align="center"><img src="https://github.com/ilyasbelfar/CHETAN-Forum/blob/main/images/Capture_Forum.PNG" alt="CHETAN Forum Capture" style="max-width: 100% !important"></p>
<p align="center">✨🚀<em>Full-stack forum website built with MERN Stack (ReactJS, NodeJS, ExpressJS, MongoDB).</em>✨🚀</p>

[Live Demo](https://CHETAN.ilyasbelfar.me)
...
```
git clone https://github.com/ilyasbelfar/CHETAN-Forum.git
cd CHETAN-Forum
```
...
1. Fork [this project](https://github.com/ilyasbelfar/CHETAN-Forum)
2. Create a branch (`git checkout -b new-branch`)
3. Commit your changes (`git commit -am 'add new feature'`)
4. Push to the branch (`git push origin new-branch`)
5. [Submit a pull request!](https://github.com/ilyasbelfar/CHETAN-Forum/pull/new/master)
